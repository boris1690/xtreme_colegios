(function (_) {
  ...
  angular.module('delta.controllers')
      .controller('monitoreoController', ['$scope', '$routeParams','$location','$window','$rootScope','$localStorage','monitoreoService','$filter','$resource', 'DTOptionsBuilder', 'DTColumnDefBuilder', function ($scope, $routeParams,$location,$window,$rootScope,$localStorage,monitoreoService,$filter,$resource, DTOptionsBuilder, DTColumnDefBuilder) {
          ...
          monitoreoService.getFiltros().then(function (data) {
          ...
          {
              monitoreoService.getEvaluaciones($scope.formCons,listado).then(function (data) {
          ...
          {
              monitoreoService.addEvaluacion($scope.formCons.evaluacion,$scope.modelEvaluado,$scope.modelEvaluador,$scope.modelRelacion,$filter('date')(new Date(),'yyyy-MM-dd')).then(function (data) {
